...
leftPock = mem[mem.columns[1:10]]
rightPock = mem[mem.columns[15:24]]
rightPock.columns = leftPock.columns
train = pd.concat([leftPock, rightPock], sort=False)
...
# callBacks = [ModelCheckpoint('model.h5', save_best_only = True, save_weights_only=False, verbose=1)]
