...
import 'package:fyp_app/widgets/dialogs/autoRequirementsDialog.dart';
import 'package:fyp_app/widgets/dialogs/autoUnlockDialog.dart';
                ...
                child: SafeArea(
                  child: Container(
                    ...
                    child: ListView(
                      ...
                      children: <Widget>[
                        Padding(
                          padding: EdgeInsets.symmetric(vertical: getProportionWidth(16.0)),
                          child: Row(
